...
\begin{figure}
  ...
  \caption{
    Comparison of Einstein radii \ER\ obtained from mass tiles directly to those obtained from a parameterized model to test the performance of the parametrisation algorithm.
    The parameterized model was generated using princible component analysis on the ensemble of models.

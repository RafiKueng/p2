...
collaborative refinement process.  This represents a consensus among
modellers, as to the best that could be achieved with the available
data and software.

We introduce some diagnostics.  There are three kinds of diagnostics.

\begin{itemize}
\item First we have diagnostics based on morphology of the system.
...
\item The image morphology concisely described: D for double, and
  ...
  SW09, SW29, SW42), IQ for inclined quads and CQ for very symmetric core quads.

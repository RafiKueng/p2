...
Light deflection at the rim of the Sun due to its gravitational field is famously $1.75''$.  The
...
matter has been studied only through its indirect consequences on galactic
...
recent years, the millennium simulation by \cite{2005Natur.435..629S} has been
...
boson fluid \citep{2016ApJ...818...89S} 
or even dark matter particles with internal degrees of freedom 
\citep{2011MNRAS..405...77}. %(Saxton & Ferreras 2010 MNRAS 405, 77)
There is a general
consensus, however, that 
basic mechanism of galaxy formation involve
...
Strong gravitational lensing over galaxy scales provides
a useful source of information on the
mutual dynamics of dark matter and gas in galaxies.  The topic has
been explored in numerous studies
...
so requires both finding more lenses and also modelling their
masses.
...
discoveries
with surveys such as Euclid or WFIRST,
will need a similarly huge modelling effort to reconstruct
...
Source redshifts were set to z=2 for all systems. %TODO justify z=2.
...
% It's purpose is twofold: First, to see if

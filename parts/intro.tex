...
tested on a sample of simulated lenses\footnote{
  Those simulated lenses were generated as part of the training set used
  in {\SW} (see \cite{2016MNRAS.455.1191M,2016MNRAS.455.1171M} for further
  information)}
from \SW.

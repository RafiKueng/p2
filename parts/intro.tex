...
\citep{2016MNRAS.455.1191M,2016MNRAS.455.1171M} have, between them,
...
for the challenge of large-sample lens modelling,
...
already participated in lens discovery through {\SW}, as well as
several other projects involving astronomical data.  The system was
tested on a sample of simulated lenses generated as part of the
training set used in {\SW} (see
\cite{2016MNRAS.455.1191M,2016MNRAS.455.1171M} for further information).
...
\item Third, whether the implied lensing mass is plausible, given the
  photometry data of the lensing galaxy.  Section~\ref{sec:stellar-mass}
...
Table~\ref{tab:models}.  Interpretation of the results is tentative,
...
that making high resolution mass maps in the central region relieves a

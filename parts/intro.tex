...
The expected flood of new lens discoveries will need a equally large
...
already participated in the discovery of gravitational lenses through
\SW, as well as in several other projects involving astronomical data.
The system was tested on a sample of simulated lenses, that were part
of the training and testing set in \SW.

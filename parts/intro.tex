...
% \textcolor{red}{\bf IF: why are they promising? explain this here).}
...
% \footnote{\textcolor{red}{\bf IF include web
%  link: {\tt http://xxx.yyy.ch}}}
...
online letter
% \textcolor{red}{\bf REFERENCE?} about 65 days later,

...
The analysis presented in this paper is somewhat limited by the fact that no source redshifts are available\footnote{Source redshifts were set to z=2 for all systems.} yet and that the redshifts of the lenses have large error bars.

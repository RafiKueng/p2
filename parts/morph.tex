...
marked up with a spaghetti diagrams.  The online supplement includes
variant spaghetti diagrams for each of these systems, and similarly
for all the modelled candidates.
...
along the short axis, IQ if inclined to both axes.  Although the
unlensed source and its location are obviously not seen, the LQ, SQ
and IQ cases correspond to easily-seen image morphologies \citep[see,

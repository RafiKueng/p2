...
\begin{table*}
  \caption{Diagnostics of a selected model for each Space Warps
    candidate (see Section~\ref{sec:summary}). A machine-readable
    version is available in the online supplement.}
  \label{tab:models}
  \include{parts/table}
\end{table*}

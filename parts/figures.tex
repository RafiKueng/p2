...
\caption{Total mass in the model against the estimated stellar mass,
  ...
  Figures~\ref{fig:splinput}--\ref{fig:encl}.)  The horizontal and
  vertical extents of each bar indicate the uncertainties in the
  stellar and total masses.  The lower-right shaded region is

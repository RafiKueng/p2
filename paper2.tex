...
\citep{2016MNRAS.455.1191M} have between them discovered an average of
four lenses per square degree.  So one can be optimistic about finding
many thousands of lenses in the next generation of wide-field surveys.
But modelling them all will be very difficult if the process is
labour-intensive.

One possibility is to enlist the help of citizen-scientists for
modelling large samples of lenses.  \cite{2015MNRAS.447.2170K}
developed a system whereby experienced but non-professional lens
enthusiasts can model newly-discovered lenses collaboratively.

...
\S~\ref{subsec:hires} we show that making mass maps fine-grained in
the central region relieves a tendency in the earlier work for mass to
be too shallow. \S~\ref{subsec:sourcefit} we introduce fitting of the
brightness profiles of the source.  This feature has not yet been
included in SpaghettiLens, but has been done for in post-processing
for a few especially interesting candidates. Then in
...
\subsection{HiRes / Subsampling of central region}\label{subsec:hires}
...
\subsection{Additional / Improved Synthetic Image}\label{subsec:sourcefit}

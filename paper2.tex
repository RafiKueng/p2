...
clumps, into which feel gas, cooling through radiative processes to
...
\citep[Space~Warps][]{2016MNRAS.455.1171M,2016MNRAS.455.1191M} have
between them discovered an average of four lenses per square degree.
So one can be optimistic about finding many thousands of lenses in the
next generation of wide-field surveys.  But modelling them all will be
very difficult if the process is labour-intensive.

\cite{2015MNRAS.447.2170K} developed a new lens-modelling strategy
developed, designed to be scaleable to much larger lens samples.  The
idea was to collaborate with experienced members of the
citizen-science community, who had already participated in lens
discovery through Space~Warps, as well as several other projects
involving astronomical data.  The

...
source behind the modelled lens; mid right: mass profile\todo{Fix
  distance factor in $\kappa$.}  ; bottom: lensing mass, obtained from
the model against estimate of stellar mass, obtained using photometric
redshift assuming \todo{which population model?}

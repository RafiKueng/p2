...
\newcommand{\inclfig}[2]{
  \centering
  \includegraphics[width=0.49\linewidth]{spaghetti/#2_input} %
  \includegraphics[width=0.49\linewidth]{spaghetti/#2_img1} \\
  \includegraphics[width=0.49\linewidth]{spaghetti/#2_img3_ipol} %
  \includegraphics[width=0.49\linewidth]{spaghetti/#2_img2} \\
  \includegraphics[width=1\linewidth]{masses/#1_#2_mstel_vs_mtot}
}

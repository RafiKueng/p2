...
Each of Figures~\ref{fig:SW28}--\ref{fig:SW57} show six panels, as
follows.
...
\item Lower left is synthetic image.
  Figures~\ref{fig:SW28}--\ref{fig:SW29} include source fitting.
  Figures~\ref{fig:SW42}--\ref{fig:SW57} uses a simple conical
  profile.
...
\item Figures~\ref{fig:SW28}--\ref{fig:SW29} show the five most
  convincing lens candidates. SW28 shown in Figure~\ref{fig:SW28} is
  modelled as an arc with three blended images plus a saddle-point
  closer to the galaxy.  SW05 shown in Figure~\ref{fig:SW05} has four
  distinct images (two close to blending).  SW02, SW09 and SW29
  (Figures~\ref{fig:SW02}--\ref{fig:SW29}) have similar
...
\item Figure~\ref{fig:SW42} shows a candidate that modelling indicates
...
\item Figures~\ref{fig:SW58} and \ref{fig:SW19} appear plausible lens
...
\item Figures~\ref{fig:SW36} and \ref{fig:SW57} shows {\em unclear\/}

...
\newcommand{\inclfig}[2]{
  \centering
	...
	\includegraphics[width=0.5\linewidth]{masses/#1_#2_mstel_vs_mtot}%
	\includegraphics[width=0.5\linewidth]{img/M_encl/#2_M_encl}
}
...
\newcommand{\inclfign}[2]{
  \centering
	\includegraphics[width=0.5\linewidth]{spaghetti/#2_input}%
	\includegraphics[width=0.5\linewidth]{spaghetti/#2_img1}
	\includegraphics[width=0.5\linewidth]{img/nsynth/#2_nsynth}%
	\includegraphics[width=0.5\linewidth]{spaghetti/#2_img2}
	\includegraphics[width=0.5\linewidth]{masses/#1_#2_mstel_vs_mtot}%
	\includegraphics[width=0.5\linewidth]{img/M_encl/#2_M_encl}
}
